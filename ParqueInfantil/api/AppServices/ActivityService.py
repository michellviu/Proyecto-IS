...
class ActivityService(GenericService, IActivityService):
    ...
    def check_for_consistency(data):
        ...
        if num_participantes > instalacion.capacidad:
            raise ValueError(
                "El número de participantes no puede ser mayor que la capacidad de la instalación."
            )
    ...
    def get_highest_average_calification_activities(self):
        return self.activity_repository.get_highest_average_calification_activities()

    def get_activities_with_highest_participation(self):
        return self.activity_repository.get_activities_with_highest_participation()
