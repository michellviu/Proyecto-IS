...
from .views import InstalacionView,InstalacionDetailView,ActividadView,ActividadDetailView,RecursoView,RecursoDetailView,UsuarioView,PadreView,EducadorView,AdministradorView,Actividad_programadaView,ReservacionView,CalificacionView
