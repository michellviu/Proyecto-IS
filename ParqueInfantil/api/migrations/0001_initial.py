# Generated by Django 5.0.4 on 2025-02-01 19:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idAP', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.actividad_programada')),
                ('idP', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.padre')),
            ],
        ),
        migrations.AddConstraint(
            model_name='calificacion',
            constraint=models.UniqueConstraint(fields=('idU', 'idAP'), name='unique_user_activity_combination'),
        ),
    ]
